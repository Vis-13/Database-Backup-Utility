...
namespace DBBackupLib
{
    public static class ServiceProvider
    {
        ...
        public const string BackupLibConstant = "BackupUtility";
        ...
        //                _settingsDir = Path.Combine(appDataPath, "DBBackup"/*nameof(Captura)*/);
        //            }
        //        }
        ...
        static string _tempBackupDir = "";
        public static string TempBackupDir { 
            get
            {
                return Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments), BackupLibConstant);
            }
            set {
                _tempBackupDir = value;
            }
        }
